...
public class Conexao {
    ...
    public void resetarBD(){
        try {
            ...
            statement.execute("DROP TABLE IF EXISTS Devolucao;");
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS Locacao(id INT PRIMARY KEY AUTOINCREMENT, cpfCliente CHARACTER(11) NOT NULL, cpfFuncionario CHARACTER(11) NOT NULL, inicioPrevisto DATE, fimPrevisto DATE, dataReservada DATE, endereco VARCHAR(255), FOREIGN KEY(cpfFuncionario) REFERENCES Funcionario(cpf), FOREIGN KEY(cpfCliente) REFERENCES Cliente(cpf));");
            statement.execute("CREATE TABLE IF NOT EXISTS Devolucao(id INT PRIMARY KEY, dataDevolucao DATE, comentarios VARCHAR(255), FOREIGN KEY(id) REFERENCES Locacao(id))");
