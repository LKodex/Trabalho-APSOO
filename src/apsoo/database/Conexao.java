...
public class Conexao {
    ...
    public void resetarBD(){
        try {
            ...
            statement.execute("CREATE TABLE IF NOT EXISTS Devolucao(id INTEGER PRIMARY KEY, dataDevolucao DATE, comentarios VARCHAR(255), FOREIGN KEY(id) REFERENCES Locacao(id))");
