...
public class SisLoc {
    ...
    public Locacao criarLocacao(Date dataInicio, Date dataFim, String endereco, Cliente cliente){
        // TODO
    }
    ...
    public List<ArtigoLocado> selecionaArtigoLocados(List<Artigo> artigosSelecionados){
        // TODO
    }
